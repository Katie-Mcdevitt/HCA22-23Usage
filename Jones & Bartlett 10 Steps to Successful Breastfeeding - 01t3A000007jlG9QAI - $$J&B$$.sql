...
-------Jones & Bartlett 10 Steps to Successful Breastfeeding-------
...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'Jones & Bartlett: 10 Steps to Successful Breastfeeding'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'FC15B3EC-2C19-EB11-80D8-005056B14C8B',
'9530DE2B-BDB4-E111-9404-0015171C5BB1',
'F50F7480-BDB4-E111-9404-0015171C5BB1')
