-------Lactation Education Resources - BreaSteps
...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'Lactation Education Resources - BreaSteps'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'783B33CB-B0DF-E911-8853-005056B12CFE',
'BA921E5E-B1DF-E911-8853-005056B12CFE'
