...
-------AORN Periop 202 Total Knee Arthroplasty-------

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AORN Periop 202: Total Knee Arthroplasty'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'090230b6-204f-e911-91bb-005056b16096'
)
order by 1
