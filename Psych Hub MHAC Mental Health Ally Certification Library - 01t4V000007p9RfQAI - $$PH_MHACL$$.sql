...
------Psych Hub MHAC: Mental Health Ally Certification Library

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'Psych Hub MHAC: Mental Health Ally Certification Library' ---INSERT PRODUCT NAME HERE
    End as Product_Name,
...
'EAC7918E-131A-EB11-80D8-005056B1753E'
