...
-------St. Lukes ALS OB - Provider AKA Advanced Life Support with an Obstetrics Focus--------

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'St. Lukes ALS OB - Provider AKA Advanced Life Support with an Obstetrics Focus'
    End as Product_Name,
...
and ci.course_id in (
'3D6DF177-06E3-EA11-89DE-005056B10652'
