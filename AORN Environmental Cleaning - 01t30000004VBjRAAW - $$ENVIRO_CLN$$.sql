-----------AORN: Environmental Cleaning Course
...
and ci.course_id in ('16E2F5F6-B912-E011-80A1-001517135401')
...
select distinct
case 
 when ci.course_name_at_time_of_enrollment  is not NULL then 'AORN: Environmental Cleaning Course'
 End as Product_Name,
u.username,
u.first_name,
u.last_name,
