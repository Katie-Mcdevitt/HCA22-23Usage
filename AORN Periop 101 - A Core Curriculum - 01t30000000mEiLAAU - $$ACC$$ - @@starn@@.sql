...
and ci.enrollment_datetime <= @PriorYearEnd  -- Replace Date Here
...
and ci.course_id in (
 ...
 'E8FB1C1E-CACB-E311-941D-005056B1522B',
 '396307E6-6CB0-E811-B688-005056B17E48',
 '77EB3728-B9B8-EB11-80E1-005056B142B5')
...
select distinct
case 
 when ci.course_name_at_time_of_enrollment  is not NULL then 'AORN PERIOP 101: A CORE CURRICULUM'
 End as Product_Name,
u.username,
u.first_name,
u.last_name,
