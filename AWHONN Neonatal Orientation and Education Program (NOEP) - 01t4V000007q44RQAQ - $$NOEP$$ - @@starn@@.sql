...
'F7C94142-A78D-EB11-80DF-005056B1202E',
'897AA72F-A78D-EB11-80DF-005056B1202E')

and ci.course_id not in (
'80101C0F-5699-EB11-80E0-005056B1202E',
'E4F12447-F39D-EB11-80E0-005056B17FCD'
)
...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AWHONN: Neonatal Orientation and Education Program (NOEP)'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
