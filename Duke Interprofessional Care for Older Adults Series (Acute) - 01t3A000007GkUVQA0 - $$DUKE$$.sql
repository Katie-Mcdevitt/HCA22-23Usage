...
-------Duke Interprofessional Care for Older Adults Series (Acute)-------

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'Duke Interprofessional Care for Older Adults Series (Acute)'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'B448191B-D21B-E711-B92E-005056B144C5',
'DACDD355-D21B-E711-B92E-005056B144C5',
'EDAA438D-D21B-E711-B92E-005056B144C5')
