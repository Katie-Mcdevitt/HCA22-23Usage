...
-------AORN Periop 202 Total Hip Arthroplasty-------
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AORN Periop 202: Total Hip Arthroplasty'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'BD86CE64-3915-EA11-B0C2-005056B11EEE',
'EA09F8FE-3915-EA11-B0C2-005056B11EEE'
