select distinct
case 
 when ci.course_name_at_time_of_enrollment  is not NULL then 'AORN - Foundations for Sterile Processing'
 End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
and ci.course_id = '02A28263-E3F9-EA11-8C3B-005056B160F2'
