...
-------Essentials of Neonatal Critical Care Orientation (ENCCO)--------
...
'57E706BB-9B69-E311-95D1-001517135213',
'5EA6CD84-9B69-E311-95D1-001517135213'
)
...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'Essentials of Neonatal Critical Care Orientation (ENCCO)'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
