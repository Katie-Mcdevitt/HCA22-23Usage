...
-------St. Lukes ALS OB - Compendium AKA ALS OB Facilitator Compendium 2020

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'St. Lukes ALS OB - Compendium AKA ALS OB Facilitator Compendium'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
and ci.course_id in (
'BD027619-3AA6-EB11-80E0-005056B134EC'
