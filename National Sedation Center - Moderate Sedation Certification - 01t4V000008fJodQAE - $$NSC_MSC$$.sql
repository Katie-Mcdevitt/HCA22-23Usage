...
-------National Sedation Center - Moderate Sedation Certification-------


select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'National Sedation Center - Moderate Sedation Certification'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
and cc.course_category_id in (

'C2C28BC0-8EF5-E711-8731-005056B14E7E',
'C8E2CBA7-34AF-E911-A6FD-005056B15B8C')
