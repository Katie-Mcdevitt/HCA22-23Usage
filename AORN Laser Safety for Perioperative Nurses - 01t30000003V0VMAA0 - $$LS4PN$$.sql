select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AORN Laser Safety for Perioperative Nurses'
    End as Product_Name,
...
and ci.course_instance_interaction_mode_id not in ('1','6','7') 
 ...
 and cccm.course_category_id in (
  ...
  '1649B594-5C8D-E111-8AF1-001517135401',
'812C542D-5D8D-E111-8AF1-001517135401')
