...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'The S.T.A.B.L.E. Program Online'
    End as Product_Name,
...
and ci.course_instance_interaction_mode_id not in ('1','6','7') 
 ...
 'CF64E5F4-3674-EA11-A221-005056B14D10',
'EE06D56C-3874-EA11-A221-005056B14D10'
