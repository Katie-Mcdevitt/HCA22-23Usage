...
------ENA: The Emergency Severity Index (ESI), Adult and Pediatric Course (English Version)

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'ENA: The Emergency Severity Index (ESI), Adult and Pediatric Course (English Version)' ---INSERT PRODUCT NAME HERE
    End as Product_Name,
...
----INSERT COURSE_CATEGORY_ID(S) BELOW
and cccm.course_category_id in ( 

'C52374F4-5BD1-EC11-80EF-005056B176BA',
'67818377-3FCD-EC11-80F1-005056B1202E'
)
