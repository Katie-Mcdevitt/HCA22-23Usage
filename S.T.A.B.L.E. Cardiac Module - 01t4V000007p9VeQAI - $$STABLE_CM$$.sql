...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'S.T.A.B.L.E. - Cardiac Module, 2nd Ed - Online Slides'
    End as Product_Name,
...
and ci.course_id = '82E598E9-76BD-EB11-80E2-005056B17C18'
