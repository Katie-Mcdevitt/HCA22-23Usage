...
-------AORN Periop 101 Cesarean Section--------
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AORN Periop 101: Cesarean Section'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
and ci.course_instance_interaction_mode_id not in ('1','6','7') 
 ...
 and ci.course_id = '1B27D585-83C0-E611-AD7D-005056B1418B'
