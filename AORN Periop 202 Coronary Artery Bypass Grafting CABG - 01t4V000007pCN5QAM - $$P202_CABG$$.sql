...
--------------------AORN Periop 202: Coronary Artery Bypass Grafting (CABG)

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AORN Periop 202: Coronary Artery Bypass Grafting (CABG)'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'CCE114A9-857B-EB11-80DE-005056B175DD',
'86AE43EF-857B-EB11-80DE-005056B175DD')
