...
select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AWHONN: Maternal Fetal Triage Index (MFTI)'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
and cc.course_category_id = '80D46CA3-2C31-E811-A509-005056B133C3'
