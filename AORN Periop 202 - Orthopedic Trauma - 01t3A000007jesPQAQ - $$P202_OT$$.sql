...
-------AORN Periop 202 - Orthopedic Trauma-------

select distinct
Case 
    when ci.course_name_at_time_of_enrollment is not NULL then 'AORN Periop 202: Orthopedic Trauma'
    End as Product_Name,
u.username,
u.first_name,
u.last_name,
...
'7EED3798-3915-EA11-B0C2-005056B11EEE',
'CB32451E-3A15-EA11-B0C2-005056B11EEE'
)
